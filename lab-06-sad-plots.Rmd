...
***I would make the `part-time faculty` line one color and the rest another color so I can focus on that only variable.***
...
fisheries %>%
  ...
  ggplot(aes(x = value, y = country, fill = type)) +
